...
class TIC_TAC_TOE_AI:
    def __init__(self, root):
        ...
        self.window = root
        self.make_canvas = Canvas(self.window, background="#232429", relief=RAISED, bd=3)
    ...
    def decorating(self):# Basic Set-up
        Label(self.make_canvas, text="Tic-Tac-Toe AI", bg="#1d1d1d", fg="#4f43a8", font=("Lato", 25, "bold")).place(x=110, y=10)
        ...
        self.reset_btn = Button(self.make_canvas, text="Reset", font=("Arial", 15, "bold", "italic"), bg="#262626", activebackground="#262626", disabledforeground="#d60e32", fg="#9d9dff", relief=RAISED, bd=3, command=self.reset, state=DISABLED)
    ...
    def control_give(self, indicator="human_first"):# Control give based on human first or computer first play
        self.machine_first_control.config(state=DISABLED, disabledforeground="#d60e32")
        self.human_first_control.config(state=DISABLED, disabledforeground="#d60e32")
        self.reset_btn.config(state=DISABLED, disabledforeground="#d60e32")
        for every in self.activate_btn:
    ...
    def __sign_insert(self, btn_indicator, sign_is="X"):# Button sign Insert
        if sign_is == "X":
            self.activate_btn[btn_indicator - 1].config(text=sign_is, state=DISABLED, disabledforeground="#d60e32")
        else:
            self.activate_btn[btn_indicator - 1].config(text=sign_is, state=DISABLED, disabledforeground="#d1cb23")
